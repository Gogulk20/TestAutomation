...
public class MainPOToInvoice {
    ...
    public static void POToInvoiceFlow() throws InterruptedException {
        ...
        String Title = "JBS Company PVT LMT";
...
//        POToInvoiceFlow.vendorCreateOSpage("10", "10", "10", driver);
...
//        POToInvoiceFlow.buyerPoDetails1(Title, driver);
...
//        POToInvoiceFlow.vendorWoDetails(driver);
        ...
        POToInvoiceFlow.vendorInvoiceCreate("Purchase", "INV-3223", "Invoice Notes", "PO-01091", driver);
